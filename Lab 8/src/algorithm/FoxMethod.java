...
public class FoxMethod {
    // Coordinates in Cartesian Lattice
    ...
    public static void compute(String[] args, int matrixSize) {
        ...
        // Send data to different cells
        matrixScatter(matrixA, tempABlock, matrixSize, blockSize);
        ...
        if (procRank == 0) {
            Logger.log("F", matrixSize, MPI.COMM_WORLD.Size(), System.currentTimeMillis() - startTime);
        }
        MPI.Finalize();
    }
}